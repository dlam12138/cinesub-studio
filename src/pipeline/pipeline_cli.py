...
def build_pipeline_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--word-timestamps", dest="word_timestamps", action="store_true", default=None, help="Enable word timestamps")
    parser.add_argument("--no-word-timestamps", dest="word_timestamps", action="store_false", help="Disable word timestamps")
    ...
    parser.add_argument("--no-resegment-subtitles", dest="resegment_subtitles", action="store_false", help="Disable subtitle resegmentation")
